...
async function generateHTML() {
    ...
    // --- 2. HTML Template ---
    // SAFE MODE: Using single quotes and + for concatenation in client scripts
    // to avoid Node.js build errors and ReferenceErrors.
    const html = `
    <!DOCTYPE html>
    <html lang="uk">
    <head>
    ...
    <body>
        ...
        <script>
            ...
            function handleReagentsImport(e) {
                ...
                // Fixed line: using concatenation instead of template literals
